...
A public component that contains only Perl code - see L</Perl-only components>.
...
You can customize the file names used for autohandlers with the
L<Mason::Params/autohandler_names> parameter.
