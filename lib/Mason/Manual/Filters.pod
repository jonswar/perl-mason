...
component class, and are applied in order from left to right. With this syntax
you cannot use anonymous subroutines or variables as filters, or pass arguments
to filters. However in a pinch you can define local filter methods to get
around this, e.g.
