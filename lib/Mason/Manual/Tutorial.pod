...
=head1 FILES FOR THIS TUTORIAL

If you want to play along and don't feel like typing all this in, the files for
this tutorial are available in the eg/ directory of the Mason distribution, or
you can view them at L<|github>.
...
See L<Moose::Manual::Components> for more information about components.
...
case '/'. (For more special paths, see L<Mason::Manual::RequestDispatch>.)
