...
C<Mason::Plugin::MyPlugin::Interp> and C<Mason::Plugin::MyPlugin::Compiler>
will be applied to Mason::Interp and Mason::Compiler respectively.
...
the plugin and bundle name syntax.
